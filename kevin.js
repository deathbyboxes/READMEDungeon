...
playerMenu.appendChild(buildElement('touch-icon', {class: 'menu-item'}, {icon: 'boxes'}));
playerMenu.appendChild(buildElement('touch-icon', {class: 'menu-item'}, {icon: 'arrows-alt'}));
